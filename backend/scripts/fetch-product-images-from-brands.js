...
async function searchProductOnBrandWebsite(brandName, productName, brandWebsite) {
    try {
                            ...
                            try {
                                ...
                                if (result) {
                                    if (result.type === 'image') {
                                        console.log(`   ✅ Found image via Puppeteer search: ${result.url}`);
                                        return result.url;
                            ...
                            if (img.length) {
                                ...
                                if (imgUrl) {
                                    ...
                                    if (!imgUrl.includes('placeholder') && !imgUrl.includes('logo') && !imgUrl.includes('icon')) {
                                        console.log(`   ✅ Found image via search: ${imgUrl}`);
                                        return imgUrl;
                                    }
                                }
                            }
        ...
        console.log(`   ⚠️  Could not find product image on ${brandWebsite}`);
